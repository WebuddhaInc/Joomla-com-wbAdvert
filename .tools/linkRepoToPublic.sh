...
# admin -> /administrator/components/com_member

  doRepoLink admin administrator/components $REPONAME
...
# media -> /media/com_member

  doRepoLink media media $REPONAME

# images -> /images/com_member
